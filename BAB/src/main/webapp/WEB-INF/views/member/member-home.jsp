					   ...
					   <c:when test="${id ne null}">
					       <div class="">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="active">
                                    <a href="/iducs/memberhome" class="waves-effect waves-dark">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Welcome to BAB</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" id="name" name="name" value="이름 : ${name}" class="form-control" disabled="disabled">
                                    
                                    <span class="form-bar"></span>
                                   	
                                </div>
                                <div class="form-group form-primary">
                                    <input type="text" id="id" name="id" value="ID : ${id}" class="form-control" disabled="disabled">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="password" id="pw" name="pw" value="${pw}" class="form-control">
                                            <span class="form-bar"></span>
                                ...
                                <div class="center">                                
                                    ...
                                    <label class="btn btn-primary btn-md" style="margin-right: 10px; border-radius:20%;">
                                        ...
                                        <input type="radio" name="status" value="professor" checked="checked">교수
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                       <a href="javascript:checkValue();" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">수정하기</a>
                                    </div>
                                </div>
                                <hr/>
